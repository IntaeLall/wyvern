...
class __TwigTemplate_64126b2bc4e753906671957b1779e63497e7c633eb3efa7c9ea6c1ec1c28459b extends Twig_Template
{
    ...
    <tr>
      <th scope=\"row\">
        <label>
          ";
        // line 7
        echo $this->env->getExtension('MailPoet\Twig\I18n')->translate("Enable signup confirmation");
        echo "
        </label>
        <p class=\"description\">
          ";
      ...
      <td>
        ...
        echo "        >";
        // line 19
        echo $this->env->getExtension('MailPoet\Twig\I18n')->translate("Signup confirmation is mandatory when using the MailPoet Sending Service.");
        // line 20
        echo "</p>
        <p
    ...
    \$(function() {
      ...
      \$('.mailpoet_signup_confirmation').on('click', function() {
        ...
        if(~~(\$(this).val()) === 1) {
          result = confirm(\"";
        // line 195
        echo $this->env->getExtension('MailPoet\Twig\I18n')->translate("Subscribers will need to activate their subscription via email in order to receive your newsletters. This is highly recommended!");
        echo "\");
        } else {
          result = confirm(\"";
        // line 197
        echo $this->env->getExtension('MailPoet\Twig\I18n')->translate("New subscribers will be automatically confirmed, without having to confirm their subscription. This is not recommended!");
        echo "\");
        }
...
";
    ...
    {
        return new Twig_Source("", "settings/signup.html", "/Users/Mac/Sites/Works/encyklopedie/wp-content/plugins/mailpoet/views/settings/signup.html");
    }
}
